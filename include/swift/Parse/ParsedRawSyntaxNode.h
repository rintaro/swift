...
public:
  ...
  bool ensureDataIsNotRecorded() {
    if (getNodeType() != DataKind::Recorded)
      return true;
  ...
  /// null).
  DataKind getNodeType() const { return Data.getKind(); }
  ...
  bool isNull() const { return getNodeType() == DataKind::Null; }

  bool isRecorded() const { return getNodeType() == DataKind::Recorded; }
  bool isDeferredLayout() const {
    return getNodeType() == DataKind::DeferredLayout;
  }
  bool isDeferredToken() const {
    return getNodeType() == DataKind::DeferredToken;
  }
