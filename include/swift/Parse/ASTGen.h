...
class ASTGen {
  ...
  /// Patterns that cannot be represented by Syntax or generated by ASTGen.
  llvm::DenseMap<SourceLoc, Pattern *> Patterns;
...
public:
  ...
  Expr *generate(const syntax::BooleanLiteralExprSyntax &Expr,
                 const SourceLoc Loc);
  Expr *generate(const syntax::DiscardAssignmentExprSyntax &Expr,
                 const SourceLoc Loc);
  ...
  Expr *generate(const syntax::ObjectLiteralExprSyntax &Expr,
                 const SourceLoc Loc);
  Expr *generate(const syntax::UnresolvedPatternExprSyntax &Expr,
                 const SourceLoc Loc);
  Expr *generate(const syntax::TypeExprSyntax &Expr,
                 const SourceLoc Loc);
...
public:
  ...
  Pattern *generate(const syntax::PatternSyntax &Pat, const SourceLoc Loc);
  Pattern *generate(const syntax::IdentifierPatternSyntax &Pat,
                    const SourceLoc Loc);
...
public:
  ...
  void addPattern(Pattern *P, const SourceLoc Loc);
  bool hasPattern(const SourceLoc Loc) const;
  Pattern *takePattern(const SourceLoc Loc);
