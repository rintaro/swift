...
public:
  ...
  explicit MacroExpansionExpr(DeclContext *dc, MacroExpansionInfo *info,
      ...
      : Expr(ExprKind::MacroExpansion, isImplicit, ty),
        FreestandingMacroExpansion(FreestandingMacroExpansion::kExpr, info),
        DC(dc), Rewritten(nullptr), Roles(roles), SubstituteDecl(nullptr) {
  ...
  static bool classof(const FreestandingMacroExpansion *expansion) {
    return expansion->getFreestandingMacroKind() ==
           FreestandingMacroExpansion::kExpr;
  }
};
