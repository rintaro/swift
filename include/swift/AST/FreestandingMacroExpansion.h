...
private:
  llvm::PointerIntPair<MacroExpansionInfo *, 1> infoAndKind;

protected:
  FreestandingMacroExpansion(Kind kind, MacroExpansionInfo *info)
...
public:
  ...
  Kind getFreestandingMacroKind() const {
    return static_cast<Kind>(infoAndKind.getInt());
  }
