...
// GLOBALFUNC_SAMELINE-DAG: Pattern/None/Flair[ExprSpecific]:               {#fn2: () -> String {|}#}[#() -> String#];
// GLOBALFUNC_SAMELINE: End completions

// GLOBALFUNC_NEWLINE: Begin completions
// FIXME-GLOBALFUNC_NEWLINE-DAG: Pattern/None/Flair[ExprSpecific]:               {#fn2: () -> String {|}#}[#() -> String#];
...
// METHOD_SAMELINE-DAG: Pattern/None/Flair[ExprSpecific]:               {#fn2: (() -> String)? {|}#}[#(() -> String)?#];
...
// FIXME-METHOD_NEWLINE-DAG: Pattern/None/Flair[ExprSpecific]:               {#fn2: (() -> String)? {|}#}[#(() -> String)?#];
...
// INIT_OVERLOADED_SAMELINE-DAG: Pattern/None/Flair[ExprSpecific]:               {#fn2: () -> String {|}#}[#() -> String#];
// INIT_OVERLOADED_SAMELINE-DAG: Pattern/None/Flair[ExprSpecific]:               {#fn3: () -> String {|}#}[#() -> String#];
...
// FIXME-INIT_OVERLOADED_NEWLINE-DAG: Pattern/None/Flair[ExprSpecific]:               {#fn2: () -> String {|}#}[#() -> String#];
// FIXME-INIT_OVERLOADED_NEWLINE-DAG: Pattern/None/Flair[ExprSpecific]:               {#fn3: () -> String {|}#}[#() -> String#];
...
// INIT_OPTIONAL_SAMELINE-DAG: Pattern/None/Flair[ExprSpecific]:               {#fn2: () -> String {|}#}[#() -> String#];
// INIT_OPTIONAL_SAMELINE-DAG: Pattern/None/Flair[ExprSpecific]:               {#fn3: () -> String {|}#}[#() -> String#];
...
// FIXME-INIT_OPTIONAL_NEWLINE-DAG: Pattern/None/Flair[ExprSpecific]:               {#fn2: () -> String {|}#}[#() -> String#];
// FIXME-INIT_OPTIONAL_NEWLINE-DAG: Pattern/None/Flair[ExprSpecific]:               {#fn3: () -> String {|}#}[#() -> String#];
...
// INIT_REQUIRED_SAMELINE_1-DAG: Pattern/None/Flair[ExprSpecific]:               {#fn2: () -> String {|}#}[#() -> String#];
// INIT_REQUIRED_SAMELINE_1: End completions

// INIT_REQUIRED_NEWLINE_1: Begin completions
// FIXME-INIT_REQUIRED_NEWLINE_1-DAG: Pattern/None/Flair[ExprSpecific]:               {#fn2: () -> String {|}#}[#() -> String#];
...
// INIT_REQUIRED_SAMELINE_2-DAG: Pattern/None/Flair[ExprSpecific]:               {#fn3: () -> String {|}#}[#() -> String#];
// INIT_REQUIRED_SAMELINE_2: End completions

// INIT_REQUIRED_NEWLINE_2: Begin completions
// FIXME-INIT_REQUIRED_NEWLINE_2-DAG: Pattern/None/Flair[ExprSpecific]:               {#fn3: () -> String {|}#}[#() -> String#];
...
// INIT_FALLBACK_1-DAG: Pattern/None/Flair[ExprSpecific]:               {#arg3: () -> _ {|}#}[#() -> _#]
...
// MEMBERDECL_SAMELINE-DAG: Pattern/None/Flair[ExprSpecific]:               {#fn2: (() -> String)? {|}#}[#(() -> String)?#]; name=fn2: (() -> String)?
...
// FIXME-MEMBERDECL_NEWLINE-DAG: Pattern/None/Flair[ExprSpecific]:               {#fn2: (() -> String)? {|}#}[#(() -> String)?#]; name=fn2: (() -> String)?
...
// INITIALIZED_VARDECL_SAMELINE-DAG: Pattern/None/Flair[ExprSpecific]:               {#fn2: () -> String {|}#}[#() -> String#];
// INITIALIZED_VARDECL_SAMELINE-DAG: Pattern/None/Flair[ExprSpecific]:               {#fn3: () -> String {|}#}[#() -> String#];
