...
// ARG-NAME1-DAG: Pattern/None/Flair[ExprSpecific]: {#b1: Int?#}[#Int?#];
// ARG-NAME1-DAG: Pattern/None/Flair[ExprSpecific]: {#b2: Int?#}[#Int?#];

// ARG-NAME2: Begin completions, 1 items
// ARG-NAME2-DAG: Pattern/None/Flair[ExprSpecific]: {#b: Int#}[#Int#];

// ARG-NAME3: Begin completions, 1 items
// ARG-NAME3-DAG: Pattern/None/Flair[ExprSpecific]: {#b: String?#}[#String?#];

// ARG-NAME4: Begin completions, 2 items
// ARG-NAME4-DAG: Pattern/None/Flair[ExprSpecific]: {#b1: String#}[#String#];
// ARG-NAME4-DAG: Pattern/None/Flair[ExprSpecific]: {#b2: String#}[#String#];
...
// HASERROR3-DAG: Pattern/None/Flair[ExprSpecific]: {#b1: <<error type>>#}[#<<error type>>#];
...
// SUBSCRIPT_2-NEXT: Pattern/None/Flair[ExprSpecific]: {#default: String#}[#String#];
...
// STATIC_METHOD_SECOND: Pattern/None/Flair[ExprSpecific]: {#arg2: Int#}[#Int#];
// STATIC_METHOD_SECOND: Pattern/None/Flair[ExprSpecific]: {#arg3: Int#}[#Int#];
// STATIC_METHOD_SECOND: Pattern/None/Flair[ExprSpecific]: {#arg4: Int#}[#Int#];
...
// STATIC_METHOD_SKIPPED: Pattern/None/Flair[ExprSpecific]: {#arg4: Int#}[#Int#];
...
// IMPLICIT_MEMBER_SECOND: Pattern/None/Flair[ExprSpecific]: {#arg2: Int#}[#Int#];
// IMPLICIT_MEMBER_SECOND: Pattern/None/Flair[ExprSpecific]: {#arg3: Int#}[#Int#];
// IMPLICIT_MEMBER_SECOND: Pattern/None/Flair[ExprSpecific]: {#arg4: Int#}[#Int#];
...
// IMPLICIT_MEMBER_SKIPPED: Pattern/None/Flair[ExprSpecific]: {#arg4: Int#}[#Int#];
...
// ARG_PARAMFLAG_INOUT-DAG: Pattern/None/Flair[ExprSpecific]: {#inoutArg: &Int#}[#inout Int#]; name=inoutArg:
...
// ARG_PARAMFLAG_AUTOCLOSURE-DAG: Pattern/None/Flair[ExprSpecific]: {#autoclosureArg: Int#}[#Int#];
...
// ARG_PARAMFLAG_IUO-DAG: Pattern/None/Flair[ExprSpecific]: {#iuoArg: Int?#}[#Int?#];
...
// ARG_PARAMFLAG_VARIADIC-DAG: Pattern/None/Flair[ExprSpecific]: {#variadicArg: Int...#}[#Int#];
...
// VARIADIC_2-DAG: Pattern/None/Flair[ExprSpecific]:          {#option1: Int#}[#Int#];
// VARIADIC_2-DAG: Pattern/None/Flair[ExprSpecific]:          {#option2: String#}[#String#];
...
// LABEL_IN_SELF_DOT_INIT-DAG: Pattern/None/Flair[ExprSpecific]:               {#b: Int#}[#Int#]
...
// MISSING_REQUIRED_PARAM-DAG: Pattern/None/Flair[ExprSpecific]:               {#z: Int#}[#Int#]
...
// NAMED_PARAMETER_WITH_LEADING_VARIADIC-DAG: Pattern/None/Flair[ExprSpecific]:               {#z: Int#}[#Int#]
...
func testCompleteLabelAfterVararg() {
  ...
  private func test(value: Rdar76355192) {
    ...
    // COMPLETE_AFTER_VARARG-NOT: Pattern/None/Flair[ExprSpecific]:               {#yArg: Foo...#}[#Foo#];
    // COMPLETE_AFTER_VARARG-NOT: Pattern/None/Flair[ExprSpecific]:               {#zArg: Foo...#}[#Foo#];
    ...
    // COMPLETE_AFTER_VARARG_WITH_PREV_PARAM-DAG: Pattern/None/Flair[ExprSpecific]:               {#yArg: Foo...#}[#Foo#];
    // COMPLETE_AFTER_VARARG_WITH_PREV_PARAM-DAG: Pattern/None/Flair[ExprSpecific]:               {#zArg: Foo...#}[#Foo#];
  ...
  private func testSr14515(value: Sr14515, foo: Foo, baz: Baz) {
    ...
    // COMPLETE_VARARG_FOLLOWED_BY_NORMAL_ARG-DAG: Pattern/None/Flair[ExprSpecific]:               {#yArg: Baz#}[#Baz#];
    ...
    // COMPLETE_ARG_AFTER_VARARG-NOT: Pattern/None/Flair[ExprSpecific]:               {#yArg: Baz#}[#Baz#];
...
// GENERIC_INITIALIZER-DAG: Pattern/None/Flair[ExprSpecific]:               {#text: String#}[#String#]
...
// OVERLOAD_LABEL1-DAG: Pattern/None/Flair[ExprSpecific]:               {#ddd: Horizontal#}[#Horizontal#];
// OVERLOAD_LABEL1: End completions
  }
  func test2 {
    self.fn(eee: .up, #^OVERLOAD_LABEL2^#)
// OVERLOAD_LABEL2: Begin completions, 2 items
// OVERLOAD_LABEL2-DAG: Pattern/None/Flair[ExprSpecific]:               {#bbb: Vertical#}[#Vertical#];
// OVERLOAD_LABEL2-DAG: Pattern/None/Flair[ExprSpecific]:               {#ddd: Horizontal#}[#Horizontal#];
