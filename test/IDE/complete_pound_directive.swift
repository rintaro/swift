...
// CONDITION-DAG: Pattern/None/Flair[ExprSpecific]:               os({#(name)#}); name=os(name)
// CONDITION-DAG: Pattern/None/Flair[ExprSpecific]:               arch({#(name)#}); name=arch(name)
// CONDITION-DAG: Pattern/None/Flair[ExprSpecific]:               canImport({#(module)#}); name=canImport(module)
// CONDITION-DAG: Pattern/None/Flair[ExprSpecific]:               targetEnvironment(simulator); name=targetEnvironment(simulator)
// CONDITION-DAG: Pattern/None/Flair[ExprSpecific]:               swift(>={#(version)#}); name=swift(>=version)
// CONDITION-DAG: Pattern/None/Flair[ExprSpecific]:               swift(<{#(version)#}); name=swift(<version)
// CONDITION-DAG: Pattern/None/Flair[ExprSpecific]:               compiler(>={#(version)#}); name=compiler(>=version)
// CONDITION-DAG: Pattern/None/Flair[ExprSpecific]:               compiler(<{#(version)#}); name=compiler(<version)
// CONDITION-DAG: Keyword[true]/None:                 true[#Bool#]; name=true
// CONDITION-DAG: Keyword[false]/None:                false[#Bool#]; name=false
// CONDITION-NOT: globalVar

// WITHFLAG: Keyword/None/Flair[ExprSpecific]:               FOO; name=FOO
// WITHFLAG: Keyword/None/Flair[ExprSpecific]:               BAR; name=BAR
